...
(function () {
    ...
    var art = {
        ...
        coal:
            '<path d="M4 15.8 7 7.6l5.6-1.4 4.6 3 2.8 6.6-4 3.8H7.8Z" ' +
            'fill="var(--i-coal)"/>' +
            '<path d="M12.6 20.4 19.4 16.6l-2.8-6.6-3.6 2 1.2 4.6Z" ' +
            'fill="var(--i-coal-deep)"/>' +
            '<path d="M7 7.6l5.6-1.4 1 5-5.4 1.2Z" ' +
            'fill="var(--i-coal-light)"/>' +
            '<path d="M9.4 13.6 12 12.4l.8 3.4-2.6.8Z" ' +
            'fill="var(--i-coal-light)"/>' +
            '<path d="M8.2 8.6 11.8 7.7l.3 1.5-3.4.8Z" ' +
            'fill="var(--i-shine)"/>',
