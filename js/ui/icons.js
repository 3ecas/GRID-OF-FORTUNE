...
(function () {
    ...
    var art = {
        dirt:
            '<g transform="translate(1.2 1.2) scale(0.0101)"><g id="dirt-Layer1">' +
            '<path d="M2008.264,1469.785l-1883.195,0c70.596,-456.39 465.564,-806.' +
            '237 941.598,-806.237c476.034,0 871.001,349.847 941.598,806.237Z" sty' +
            'le="fill:#8b6a47;"/><path d="M1066.667,1469.785l-941.598,0c70.596,-4' +
            '56.39 465.564,-806.237 941.598,-806.237l-0,806.237Z" style="fill:#af' +
            '8a63;"/><circle cx="810.417" cy="881.25" r="85.417" style="fill:#d2b' +
            '494;"/><circle cx="1342.211" cy="1211.86" r="75.64" style="fill:#d2b' +
            '494;"/><circle cx="574.005" cy="1159.329" r="178.171" style="fill:#d' +
            '2b494;"/><circle cx="1631.693" cy="1165.026" r="147.474" style="fill' +
            ':#d2b494;"/><circle cx="1139.724" cy="976.264" r="156.391" style="fi' +
            'll:#d2b494;"/><circle cx="1008.813" cy="1320.353" r="87.98" style="f' +
            'ill:#d2b494;"/><circle cx="1299.971" cy="882.45" r="77.845" style="f' +
            'ill:#eedcc8;"/><circle cx="411.112" cy="1275.529" r="86.678" style="' +
            'fill:#eedcc8;"/><circle cx="1574.991" cy="1065.357" r="80.673" style' +
            '="fill:#eedcc8;"/></g></g>',

        rock:
            '<g transform="translate(3.6258 5.7141) scale(0.0422)"><g transform="' +
            'matrix(1,0,0,1,-57.5,-107)"> <g id="rock-Layer1" transform="matrix(1' +
            '.127182,0,0,1.127182,-37.622195,-70.141921)"> <path d="M417.077,210.' +
            '385L425.062,226.354L425.062,244.097L430.385,267.164L432.159,288.456L' +
            '436.595,308.86L433.046,322.168L415.303,354.993L405.544,375.398L391.3' +
            '5,390.48L348.765,399.352L307.069,417.095L280.454,421.531L246.741,405' +
            '.562L253.763,259.522L417.077,210.385Z" style="fill:rgb(140,143,138);' +
            '"/> <path d="M281.341,421.531L222.788,419.756L185.527,411.772L152.70' +
            '1,402.9L110.117,384.27L87.938,357.655L84.389,307.086L89.712,274.261L' +
            '89.712,252.082L86.164,230.79L94.027,209.276L94.148,208.61L284.889,26' +
            '0.066L285.777,292.004L277.792,330.152L277.792,386.044L281.341,421.53' +
            '1Z" style="fill:rgb(178,181,175);"/> <g transform="matrix(0.497429,-' +
            '0.497429,0.497429,0.497429,52.051391,256.686382)"> <path d="M341.221' +
            ',141.129L384.025,216.036L422.371,279.351L413.453,320.372L357.273,310' +
            '.562L263.639,265.083L198.701,212.082L146.819,142.913L115.608,65.33L9' +
            '0.639,-6.01L157.52,9.15L227.077,37.686L277.907,90.299L341.221,141.12' +
            '9Z" style="fill:rgb(208,211,205);"/> </g> <g transform="matrix(0.160' +
            '565,-0.160565,0.160565,0.160565,147.984569,206.138708)"> <path d="M3' +
            '41.221,141.129L384.025,216.036L422.371,279.351L413.453,320.372L357.2' +
            '73,310.562L263.639,265.083L198.701,212.082L146.819,142.913L115.608,6' +
            '5.33L90.639,-6.01L157.52,9.15L227.077,37.686L277.907,90.299L341.221,' +
            '141.129Z" style="fill:rgb(234,235,232);"/> </g> </g> </g></g>',

        coal:
            '<path d="M3.8 14.6 6.2 8.8 11 6.2 16.4 7.6 20.2 12.2 19.4 17.6 15 20 8.2 19.8 4.6 16.8Z" ' +
            'fill="var(--i-coal)"/>' +
            '<path d="M11 6.2 16.4 7.6 20.2 12.2 19.4 17.6 15 20 12.2 19.9 11.4 12.8Z" ' +
            'fill="var(--i-coal-deep)"/>' +
            '<path d="M6.2 8.8 11 6.2l.6 5.4-5 1.4Z" ' +
            'fill="var(--i-coal-light)"/>' +
            '<path d="M9.6 14.2 12.4 13.2l.7 3.6-2.8.8Z" ' +
            'fill="var(--i-coal-light)"/>' +
            '<path d="M7.3 9.5 10.6 7.7l.2 1.5-3.1 1.4Z" ' +
            'fill="var(--i-shine)"/>',

        iron:
            '<path d="M2.4 8h19.2l-2 9.4H4.4Z" ' +
            'fill="var(--i-iron)"/>' +
            '<path d="M12 8h9.6l-2 9.4H12Z" ' +
            'fill="var(--i-iron-deep)"/>' +
            '<path d="M2.4 8h19.2l-.6 2.8H3Z" ' +
            'fill="var(--i-iron-light)"/>' +
            '<path d="M4.9 12.6h14.2l-.4 1.9H5.3Z" ' +
            'fill="var(--i-iron-deep)"/>' +
            '<path d="M6.6 15a1.1 1.1 0 1 1 0 2.2 1.1 1.1 0 0 1 0-2.2Zm5.4 0a1.1 1.1 0 1 1 0 2.2 1.1 1.1 0 0 1 0-2.2Zm5.4 0a1.1 1.1 0 1 1 0 2.2 1.1 1.1 0 0 1 0-2.2Z" ' +
            'fill="var(--i-iron-deep)"/>' +
            '<path d="M3.6 8.7h6.6l-.4 1.4H3.3Z" ' +
            'fill="var(--i-shine)"/>',
