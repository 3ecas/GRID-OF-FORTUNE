...
(function () {
    ...
    var art = {
        dirt:
            '<path d="M2 20c0-5 4.5-8.6 10-8.6S22 15 22 20Z" ' +
            'fill="var(--i-dirt)"/>' +
            '<path d="M12 11.4c5.5 0 10 3.6 10 8.6h-10Z" ' +
            'fill="var(--i-dirt-deep)"/>' +
            '<path d="M6.6 14.4a1.9 1.9 0 1 1 0 3.8 1.9 1.9 0 0 1 0-3.8Z" ' +
            'fill="var(--i-dirt-light)"/>' +
            '<path d="M12.4 13a1.2 1.2 0 1 1 0 2.4 1.2 1.2 0 0 1 0-2.4Zm4.4 3.2a1 1 0 1 1 0 2 1 1 0 0 1 0-2Z" ' +
            'fill="var(--i-dirt-light)"/>' +
            '<path d="M5.2 17.4a1 1 0 1 1 0 2 1 1 0 0 1 0-2Z" ' +
            'fill="var(--i-shine)"/>',

        rock:
            '<path d="M2.6 19.6 4.4 9.8 12 5.6l7.6 4.2 1.8 9.8Z" ' +
            'fill="var(--i-rock)"/>' +
            '<path d="M12 12.8l7.6-3 1.8 9.8H12Z" ' +
            'fill="var(--i-rock-deep)"/>' +
            '<path d="M4.4 9.8 12 5.6l7.6 4.2L12 12.8Z" ' +
            'fill="var(--i-rock-light)"/>' +
            '<path d="M8 13.8l2.4 5.8H8.6L6.6 14Zm7.4.4 1.6 5.4h-1.4l-1.4-5Z" ' +
            'fill="var(--i-rock-deep)"/>' +
            '<path d="M6.4 9.6 12 6.8l2.6 1.4-5.4 2.6Z" ' +
            'fill="var(--i-shine)"/>',
